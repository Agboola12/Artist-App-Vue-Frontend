 <template>
        ...
        <!-- <router-link to="homeuser" style="margin-left: 90%;"><button class="btn btn p-3">Go Back Home</button></router-link> -->
...
export default {
    ...
    methods:{
        ...
        onSend(){
            ...
            localStorage.setItem('users', JSON.stringify({...getUsers,time:this.time, }))
           this.$router.push('/bookingsix')
        }
